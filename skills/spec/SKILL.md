...
- **Scope boundary.** Which components does this change touch? (CLI, relay, web viewer, encryption, protocol)
- **Reserved terms check.** Verify no collision with Lockwire domain vocabulary (Session, Code, Sharer, Viewer, Stream Key, Epoch, Relay — defined in `specs/index.spec.md`)
